...
const lvl001: LevelDefinition = {
    cellDefinitions: [
        ...
        { cellType: Wiese, pos: new HexPosition(1, 2) },
        { cellType: Waldboden, pos: new HexPosition(0, 3) },
        { cellType: Waldboden, pos: new HexPosition(-1, 3) },
        { cellType: Waldboden, pos: new HexPosition(-2, 3) },
    ...
    contentDefinitions: [
        ...
        { contentType: Steinbrocken, pos: new HexPosition(0, -4) },
    ...
    effectDefinitions: [
        { effectType: Gewitter, pos: new HexPosition(3, 0), mustBeExecuted: (step) => step === 0 },
        { effectType: Regen, pos: new HexPosition(2, -2), mustBeExecuted: (step) => step % 12 === 0 },
    ],
    levelID: 'lvl001',
