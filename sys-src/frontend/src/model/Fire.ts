...
export default class Fire {
    ...
    private static intToIntensity(int: number): FireIntensity {
        switch (int) {
            ...
            case 1:
                return FireIntensity.INTENSITY_1;
            case 2:
                return FireIntensity.INTENSITY_2;
            case 3:
                return FireIntensity.INTENSITY_3;
            case 4:
                return FireIntensity.INTENSITY_4;
            case 5:
                return FireIntensity.INTENSITY_5;
            case 6:
                return FireIntensity.INTENSITY_6;
            case 7:
                return FireIntensity.INTENSITY_7;
            case 8:
                return FireIntensity.INTENSITY_8;
            case 9:
                return FireIntensity.INTENSITY_9;
            case 10:
                return FireIntensity.INTENSITY_10;
            case 11:
                return FireIntensity.INTENSITY_11;
            case 12:
                return FireIntensity.INTENSITY_12;
            default:
                return FireIntensity.INTENSITY_0;
        }
    }
    ...
    static modify(
        ...
        if (amount > 0) {
            ...
            return this.intToIntensity(
                Math.min(this.intensityToInt(maxIntensity), this.intensityToInt(intensity) + Math.floor(amount)),
            );
        } else if (amount < 0) {
            return this.intToIntensity(
                Math.max(
